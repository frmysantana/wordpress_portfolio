  ...
  <main>
    <section class="section__latest-projects">
        ...
        while($projects->have_posts()) {
          $projects->the_post(); ?>
          <figure>
            <a class="section__latest-projects__link" href="<?php esc_url(the_permalink()); ?>"><?php echo wp_get_attachment_image(get_field('project_image')['id'], 'singleSize', false, array("class" => "section__latest-projects__screenshot")); ?></a>
        ...
        wp_reset_postdata();
        ?>
        <a href="<?php echo esc_url(site_url('/blog')); ?>"><h4 class="section__latest-projects__see-all">See all projects &rarr;<h4></a> 
    </section>
      ...
      <div class="container container--home-page">
        <div class="containter--column section-about__bio">
          <p>
            ...
            If anything you see on my website piques your interest, feel free to use my <a href="<?php echo esc_url(site_url('/contact')); ?>">contact page</a> to send me a message! You can also see my <a href="<?php echo esc_url(wp_get_attachment_url(159)); ?>">resume here</a>.
          </p>
