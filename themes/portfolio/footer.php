    <footer  class="footer">
      <div class="container">
        <p class="footer__tag-line">Designed and Coded by <a href="<?php echo site_url('/#about'); ?>"> Fremy Santana</a>.<br><br>See Fremy's resume <a href="<?php echo wp_get_attachment_url(159); ?>">here</a>.<br><br> Hero image was taken by 
